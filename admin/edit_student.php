...
// Fetch all parents for the select list
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $update_stmt = $pdo->prepare("UPDATE students SET student_number = ?, full_name = ?, grade_level = ?, parent_id = ? WHERE id = ?");
        $update_stmt->execute([$student_number, $full_name, $grade_level, $parent_id, $student_id]);
    ...
    <div class="form-card">
        ...
        <form method="POST" autocomplete="off">
            <div class="form-group">
                ...
                <input type="text" id="student_number" name="student_number" value="<?= htmlspecialchars($student['student_number'] ?? $student['student_id'] ?? '') ?>" required>
            </div>
            <div class="form-group">
